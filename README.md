...
- [dbos-openai-agents](https://github.com/dbos-inc/dbos-openai-agents) — Augment OpenAI Agents SDK with durable execution to help you build reliable and scalable multi-agent applications.
- [dbos-crewai](https://github.com/dbos-inc/dbos-crewai) - CrewAI durable agent with DBOS.
